...
class Models_InformeRiesgo extends DB_Connect {
...
NVL((
    ...
    inner join ocpreporte.estado_alerta ea on ca.idestadoocp=ea.id 
     where ca.idalerta=cc.id and ca.idtipoalerta=3 ORDER BY ca.id desc FETCH NEXT 1 ROWS ONLY  
),'PENDIENTE') as estado_ocp,
LPAD(l.codigo, 5, '0') as codigo
...
where enviado=1 and cc.activo=1 AND l.idtipoLaft=3 
  ";
